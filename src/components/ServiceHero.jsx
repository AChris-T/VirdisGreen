  ...
  return (
    ...
    >
      <motion.h3
        ...
        className="w-full md:w-[95%] lg:w-[58%] leading-12 text-center text-green-100 font-semibold flex justify-center text-[30px] md:text-[44px]"
      >
              ...
              <div className="flex gap-4 md:gap-0 h-full md: md:justify-between items-center ">
                ...
                {tabs.map((tab) => (
                  <motion.button
                    ...
                    whileHover="hover"
                    whileTap="tap"
                    className={`px-5 hover:border-1 flex border-1 rounded-full border-black-500 hover:bg-yellow-200 hover:border-green-100 hover:rounded-full items-center text-green-100 gap-[5px] py-2 text-base font-medium focus:outline-none transition-all duration-200
                      ${
                        activeTab === tab.id
